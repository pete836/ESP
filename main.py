...
def main():
    ...
    mqtt_client.subscribe(MQTT_TOPIC_BAZINGA)
    ...
    tim = machine.Timer(-1)
    tim.init(period=5000, mode=machine.Timer.PERIODIC, callback=tick.do)
